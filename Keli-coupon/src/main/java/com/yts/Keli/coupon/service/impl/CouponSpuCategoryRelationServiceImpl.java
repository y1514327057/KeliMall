...
import com.yts.Keli.coupon.dao.CouponSpuCategoryRelationDao;
import com.yts.Keli.coupon.entity.CouponSpuCategoryRelationEntity;
import com.yts.Keli.coupon.service.CouponSpuCategoryRelationService;
...
public class CouponSpuCategoryRelationServiceImpl extends ServiceImpl<CouponSpuCategoryRelationDao, CouponSpuCategoryRelationEntity> implements CouponSpuCategoryRelationService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<CouponSpuCategoryRelationEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<CouponSpuCategoryRelationEntity> resultPage = this.page(
                page,
