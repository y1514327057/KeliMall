...
import com.yts.Keli.coupon.dao.HomeAdvDao;
import com.yts.Keli.coupon.entity.HomeAdvEntity;
import com.yts.Keli.coupon.service.HomeAdvService;
...
public class HomeAdvServiceImpl extends ServiceImpl<HomeAdvDao, HomeAdvEntity> implements HomeAdvService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<HomeAdvEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<HomeAdvEntity> resultPage = this.page(
                page,
