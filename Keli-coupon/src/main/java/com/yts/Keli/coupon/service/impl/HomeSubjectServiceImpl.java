...
import com.yts.Keli.coupon.dao.HomeSubjectDao;
import com.yts.Keli.coupon.entity.HomeSubjectEntity;
import com.yts.Keli.coupon.service.HomeSubjectService;
...
public class HomeSubjectServiceImpl extends ServiceImpl<HomeSubjectDao, HomeSubjectEntity> implements HomeSubjectService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<HomeSubjectEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<HomeSubjectEntity> resultPage = this.page(
                page,
