...
import com.yts.Keli.coupon.dao.HomeSubjectSpuDao;
import com.yts.Keli.coupon.entity.HomeSubjectSpuEntity;
import com.yts.Keli.coupon.service.HomeSubjectSpuService;
...
public class HomeSubjectSpuServiceImpl extends ServiceImpl<HomeSubjectSpuDao, HomeSubjectSpuEntity> implements HomeSubjectSpuService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<HomeSubjectSpuEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<HomeSubjectSpuEntity> resultPage = this.page(
                page,
