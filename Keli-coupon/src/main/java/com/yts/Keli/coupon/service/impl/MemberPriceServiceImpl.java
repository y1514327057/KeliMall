...
import com.yts.Keli.coupon.dao.MemberPriceDao;
import com.yts.Keli.coupon.entity.MemberPriceEntity;
import com.yts.Keli.coupon.service.MemberPriceService;
...
public class MemberPriceServiceImpl extends ServiceImpl<MemberPriceDao, MemberPriceEntity> implements MemberPriceService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<MemberPriceEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<MemberPriceEntity> resultPage = this.page(
                page,
