...
import com.yts.Keli.coupon.dao.SeckillSessionDao;
import com.yts.Keli.coupon.entity.SeckillSessionEntity;
import com.yts.Keli.coupon.service.SeckillSessionService;
...
public class SeckillSessionServiceImpl extends ServiceImpl<SeckillSessionDao, SeckillSessionEntity> implements SeckillSessionService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SeckillSessionEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<SeckillSessionEntity> resultPage = this.page(
                page,
