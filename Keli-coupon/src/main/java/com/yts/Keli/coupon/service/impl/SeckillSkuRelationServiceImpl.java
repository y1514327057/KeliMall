...
import com.yts.Keli.coupon.dao.SeckillSkuRelationDao;
import com.yts.Keli.coupon.entity.SeckillSkuRelationEntity;
import com.yts.Keli.coupon.service.SeckillSkuRelationService;
...
public class SeckillSkuRelationServiceImpl extends ServiceImpl<SeckillSkuRelationDao, SeckillSkuRelationEntity> implements SeckillSkuRelationService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SeckillSkuRelationEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<SeckillSkuRelationEntity> resultPage = this.page(
                page,
