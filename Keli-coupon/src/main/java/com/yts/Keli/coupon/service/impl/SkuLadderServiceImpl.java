...
import com.yts.Keli.coupon.dao.SkuLadderDao;
import com.yts.Keli.coupon.entity.SkuLadderEntity;
import com.yts.Keli.coupon.service.SkuLadderService;
...
public class SkuLadderServiceImpl extends ServiceImpl<SkuLadderDao, SkuLadderEntity> implements SkuLadderService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SkuLadderEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<SkuLadderEntity> resultPage = this.page(
                page,
