...
import com.yts.Keli.coupon.dao.SpuBoundsDao;
import com.yts.Keli.coupon.entity.SpuBoundsEntity;
import com.yts.Keli.coupon.service.SpuBoundsService;
...
public class SpuBoundsServiceImpl extends ServiceImpl<SpuBoundsDao, SpuBoundsEntity> implements SpuBoundsService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SpuBoundsEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<SpuBoundsEntity> resultPage = this.page(
                page,
