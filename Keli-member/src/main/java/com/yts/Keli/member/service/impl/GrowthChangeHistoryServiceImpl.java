...
import com.yts.Keli.member.dao.GrowthChangeHistoryDao;
import com.yts.Keli.member.entity.GrowthChangeHistoryEntity;
import com.yts.Keli.member.service.GrowthChangeHistoryService;
...
public class GrowthChangeHistoryServiceImpl extends ServiceImpl<GrowthChangeHistoryDao, GrowthChangeHistoryEntity> implements GrowthChangeHistoryService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<GrowthChangeHistoryEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<GrowthChangeHistoryEntity> resultPage = this.page(
                page,
