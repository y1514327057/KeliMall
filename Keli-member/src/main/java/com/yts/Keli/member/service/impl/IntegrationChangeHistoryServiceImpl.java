...
import com.yts.Keli.member.dao.IntegrationChangeHistoryDao;
...
public class IntegrationChangeHistoryServiceImpl extends ServiceImpl<IntegrationChangeHistoryDao, IntegrationChangeHistoryEntity> implements IntegrationChangeHistoryService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<IntegrationChangeHistoryEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<IntegrationChangeHistoryEntity> resultPage = this.page(
                page,
