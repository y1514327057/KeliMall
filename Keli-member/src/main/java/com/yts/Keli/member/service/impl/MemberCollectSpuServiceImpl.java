...
import com.yts.Keli.member.dao.MemberCollectSpuDao;
import com.yts.Keli.member.entity.MemberCollectSpuEntity;
import com.yts.Keli.member.service.MemberCollectSpuService;
...
public class MemberCollectSpuServiceImpl extends ServiceImpl<MemberCollectSpuDao, MemberCollectSpuEntity> implements MemberCollectSpuService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<MemberCollectSpuEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<MemberCollectSpuEntity> resultPage = this.page(
                page,
