...
import com.yts.Keli.member.dao.MemberCollectSubjectDao;
import com.yts.Keli.member.entity.MemberCollectSubjectEntity;
import com.yts.Keli.member.service.MemberCollectSubjectService;
...
public class MemberCollectSubjectServiceImpl extends ServiceImpl<MemberCollectSubjectDao, MemberCollectSubjectEntity> implements MemberCollectSubjectService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<MemberCollectSubjectEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<MemberCollectSubjectEntity> resultPage = this.page(
                page,
