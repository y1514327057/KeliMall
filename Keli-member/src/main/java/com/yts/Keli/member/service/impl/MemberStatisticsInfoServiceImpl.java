...
import com.yts.Keli.member.dao.MemberStatisticsInfoDao;
import com.yts.Keli.member.entity.MemberStatisticsInfoEntity;
import com.yts.Keli.member.service.MemberStatisticsInfoService;
...
public class MemberStatisticsInfoServiceImpl extends ServiceImpl<MemberStatisticsInfoDao, MemberStatisticsInfoEntity> implements MemberStatisticsInfoService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<MemberStatisticsInfoEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<MemberStatisticsInfoEntity> resultPage = this.page(
                page,
