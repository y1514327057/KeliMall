...
import com.yts.Keli.order.dao.OrderOperateHistoryDao;
import com.yts.Keli.order.entity.OrderOperateHistoryEntity;
import com.yts.Keli.order.service.OrderOperateHistoryService;
...
public class OrderOperateHistoryServiceImpl extends ServiceImpl<OrderOperateHistoryDao, OrderOperateHistoryEntity> implements OrderOperateHistoryService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<OrderOperateHistoryEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<OrderOperateHistoryEntity> resultPage = this.page(
                page,
