...
import com.yts.Keli.order.dao.OrderDao;
import com.yts.Keli.order.entity.OrderEntity;
import com.yts.Keli.order.service.OrderService;
...
public class OrderServiceImpl extends ServiceImpl<OrderDao, OrderEntity> implements OrderService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<OrderEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<OrderEntity> resultPage = this.page(
                page,
