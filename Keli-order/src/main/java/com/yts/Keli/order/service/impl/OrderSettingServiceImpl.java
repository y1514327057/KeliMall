...
import com.yts.Keli.order.dao.OrderSettingDao;
import com.yts.Keli.order.entity.OrderSettingEntity;
import com.yts.Keli.order.service.OrderSettingService;
...
public class OrderSettingServiceImpl extends ServiceImpl<OrderSettingDao, OrderSettingEntity> implements OrderSettingService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<OrderSettingEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<OrderSettingEntity> resultPage = this.page(
                page,
