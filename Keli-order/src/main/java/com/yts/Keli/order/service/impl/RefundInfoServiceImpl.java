...
import com.yts.Keli.order.dao.RefundInfoDao;
import com.yts.Keli.order.entity.RefundInfoEntity;
import com.yts.Keli.order.service.RefundInfoService;
...
public class RefundInfoServiceImpl extends ServiceImpl<RefundInfoDao, RefundInfoEntity> implements RefundInfoService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<RefundInfoEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<RefundInfoEntity> resultPage = this.page(
                page,
