...
import com.yts.Keli.order.dao.UndoLogDao;
import com.yts.Keli.order.entity.UndoLogEntity;
import com.yts.Keli.order.service.UndoLogService;
...
public class UndoLogServiceImpl extends ServiceImpl<UndoLogDao, UndoLogEntity> implements UndoLogService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<UndoLogEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<UndoLogEntity> resultPage = this.page(
                page,
