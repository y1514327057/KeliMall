...
import com.yts.Keli.product.dao.AttrAttrgroupRelationDao;
import com.yts.Keli.product.entity.AttrAttrgroupRelationEntity;
import com.yts.Keli.product.service.AttrAttrgroupRelationService;
...
public class AttrAttrgroupRelationServiceImpl extends ServiceImpl<AttrAttrgroupRelationDao, AttrAttrgroupRelationEntity> implements AttrAttrgroupRelationService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<AttrAttrgroupRelationEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<AttrAttrgroupRelationEntity> resultPage = this.page(
                page,
