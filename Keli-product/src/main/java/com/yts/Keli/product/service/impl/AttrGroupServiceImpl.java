...
import com.yts.Keli.product.dao.AttrGroupDao;
import com.yts.Keli.product.entity.AttrGroupEntity;
import com.yts.Keli.product.service.AttrGroupService;
...
public class AttrGroupServiceImpl extends ServiceImpl<AttrGroupDao, AttrGroupEntity> implements AttrGroupService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<AttrGroupEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<AttrGroupEntity> resultPage = this.page(
                page,
