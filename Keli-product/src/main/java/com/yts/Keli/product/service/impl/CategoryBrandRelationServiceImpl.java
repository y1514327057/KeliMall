...
import com.yts.Keli.product.dao.CategoryBrandRelationDao;
import com.yts.Keli.product.entity.CategoryBrandRelationEntity;
import com.yts.Keli.product.service.CategoryBrandRelationService;
...
public class CategoryBrandRelationServiceImpl extends ServiceImpl<CategoryBrandRelationDao, CategoryBrandRelationEntity> implements CategoryBrandRelationService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<CategoryBrandRelationEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<CategoryBrandRelationEntity> resultPage = this.page(
                page,
