...
import com.yts.Keli.product.dao.SkuImagesDao;
import com.yts.Keli.product.entity.SkuImagesEntity;
import com.yts.Keli.product.service.SkuImagesService;
...
public class SkuImagesServiceImpl extends ServiceImpl<SkuImagesDao, SkuImagesEntity> implements SkuImagesService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SkuImagesEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<SkuImagesEntity> resultPage = this.page(
                page,
