...
import com.yts.Keli.product.dao.SkuInfoDao;
import com.yts.Keli.product.entity.SkuInfoEntity;
import com.yts.Keli.product.service.SkuInfoService;
...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoDao, SkuInfoEntity> implements SkuInfoService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SkuInfoEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<SkuInfoEntity> resultPage = this.page(
                page,
