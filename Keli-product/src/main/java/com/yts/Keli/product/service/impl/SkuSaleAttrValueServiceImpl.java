...
import com.yts.Keli.product.dao.SkuSaleAttrValueDao;
import com.yts.Keli.product.entity.SkuSaleAttrValueEntity;
import com.yts.Keli.product.service.SkuSaleAttrValueService;
...
public class SkuSaleAttrValueServiceImpl extends ServiceImpl<SkuSaleAttrValueDao, SkuSaleAttrValueEntity> implements SkuSaleAttrValueService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SkuSaleAttrValueEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<SkuSaleAttrValueEntity> resultPage = this.page(
                page,
