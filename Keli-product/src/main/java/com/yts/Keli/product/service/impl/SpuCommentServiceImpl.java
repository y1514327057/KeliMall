...
import com.yts.Keli.product.dao.SpuCommentDao;
import com.yts.Keli.product.entity.SpuCommentEntity;
import com.yts.Keli.product.service.SpuCommentService;
...
public class SpuCommentServiceImpl extends ServiceImpl<SpuCommentDao, SpuCommentEntity> implements SpuCommentService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SpuCommentEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<SpuCommentEntity> resultPage = this.page(
                page,
