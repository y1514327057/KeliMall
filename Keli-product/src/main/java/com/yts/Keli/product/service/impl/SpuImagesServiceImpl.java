...
import com.yts.Keli.product.dao.SpuImagesDao;
import com.yts.Keli.product.entity.SpuImagesEntity;
import com.yts.Keli.product.service.SpuImagesService;
...
public class SpuImagesServiceImpl extends ServiceImpl<SpuImagesDao, SpuImagesEntity> implements SpuImagesService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SpuImagesEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<SpuImagesEntity> resultPage = this.page(
                page,
