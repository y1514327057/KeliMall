...
import com.yts.Keli.product.dao.SpuInfoDescDao;
import com.yts.Keli.product.entity.SpuInfoDescEntity;
import com.yts.Keli.product.service.SpuInfoDescService;
...
public class SpuInfoDescServiceImpl extends ServiceImpl<SpuInfoDescDao, SpuInfoDescEntity> implements SpuInfoDescService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<SpuInfoDescEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<SpuInfoDescEntity> resultPage = this.page(
                page,
