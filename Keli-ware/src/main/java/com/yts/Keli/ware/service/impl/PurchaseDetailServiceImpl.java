...
import com.yts.Keli.ware.dao.PurchaseDetailDao;
import com.yts.Keli.ware.entity.PurchaseDetailEntity;
import com.yts.Keli.ware.service.PurchaseDetailService;
...
public class PurchaseDetailServiceImpl extends ServiceImpl<PurchaseDetailDao, PurchaseDetailEntity> implements PurchaseDetailService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<PurchaseDetailEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<PurchaseDetailEntity> resultPage = this.page(
                page,
