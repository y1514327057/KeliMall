...
import com.yts.Keli.ware.dao.WareSkuDao;
import com.yts.Keli.ware.entity.WareSkuEntity;
import com.yts.Keli.ware.service.WareSkuService;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
    ...
    public PageUtils queryPage(Map<String, Object> params) {
        ...
        IPage<WareSkuEntity> page = new Page<>(pageNum, pageSize);

        // 执行分页查询，MyBatis-Plus会自动处理分页逻辑
        IPage<WareSkuEntity> resultPage = this.page(
                page,
